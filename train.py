...
model = {
	'LSR': models.LSR,
	'LSREVI':models.LSREVI,
	'LSRPIPELINE':models.LSRPIPELINE
}
if 'LSREVI' in args.model_name:
	con = config.ConfigEvi(args)
elif 'PIPELINE' in args.model_name:
	con = config.ConfigPipeline(args)
else:
